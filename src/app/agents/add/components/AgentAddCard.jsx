      ...
      <Card>
        <CardBody>
          <div className="d-flex align-items-center gap-2 border-bottom pb-3">
            <img src={avatar2} alt="avatar" className="avatar-lg rounded-3 border border-light border-3" />
          ...
          <ul className="list-inline d-flex gap-1 mb-0 align-items-center">
            <li className="list-inline-item">
              <Link to="" className="btn btn-soft-primary  avatar-sm d-flex align-items-center justify-content-center">
                <span>
                  {' '}
