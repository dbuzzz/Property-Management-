  ...
  return <Col lg={6}>
      <Card>
        <CardHeader className="d-flex  justify-content-between align-items-center border-0">
          <CardTitle as={'h4'}>Traffic Overview </CardTitle>
          <Dropdown>
          ...
          <div className="bg-light-subtle p-1 rounded">
            <Row className="text-center">
              <Col lg={3} xs={3} className="border-end">
                ...
                <p className="fs-16 text-dark fw-medium mb-1">1447</p>
              </Col>
              <Col lg={3} xs={3} className="border-end">
                <p className="mb-1 text-muted">Website Traffic</p>
                <p className="fs-16 text-dark fw-medium mb-1">567</p>
              </Col>
              <Col lg={3} xs={3} className="border-end">
                <p className="mb-1 text-muted">Social Media Traffic</p>
                <p className="fs-16 text-dark fw-medium mb-1">456</p>
              </Col>
              <Col lg={3} xs={3}>
                <p className="mb-1 text-muted">Market Traffic</p>
                <p className="fs-16 text-dark fw-medium mb-1">321</p>
              </Col>
            </Row>
          </div>
        </CardFooter>
